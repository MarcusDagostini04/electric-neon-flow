    ...
    <div className="container mx-auto px-4 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="text-foreground/70 hover:text-neon-primary transition-colors">
            Conteúdo
          </button>
      ...
      {isOpen && <div className="md:hidden mt-4 pb-4 border-t border-neon-primary/20 pt-4">
        <div className="flex flex-col gap-4">
          <button onClick={() => { window.scrollTo({ top: 0, behavior: 'smooth' }); setIsOpen(false); }} className="text-left text-foreground/70 hover:text-neon-primary transition-colors py-2">
            Conteúdo
          </button>
