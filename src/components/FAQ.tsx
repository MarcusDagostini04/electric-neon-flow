...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Não. Nos módulos 3 e 6, ensinamos exatamente quais ferramentas são essenciais e onde comprá-las pelo melhor preço. Você pode começar com um investimento baixo e ir aumentando conforme cresce."
    },
    {
